...
namespace CapaPresentacion.Validaciones.ProhibicionesAnticipadas.ValidacionesProhibicionesAnticipadas
{
    public class ProhibicionAnticipadaNuevaValidator : AbstractValidator<ProhibicionAnticipadaDatos>
    {
        public ProhibicionAnticipadaNuevaValidator()
        {
            ...
            RuleFor(x => x.txtDetalleVisitaAnticipada)
                .Cascade(CascadeMode.Stop)
